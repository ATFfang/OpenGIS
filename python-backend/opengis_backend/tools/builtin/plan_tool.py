...
- **needs_context=True**: the tool runs in the parent worker thread and
...
def _resolve_plan_id(ctx: ToolContext, plan_id: Optional[str]) -> str:
    if plan_id:
        return str(plan_id)
