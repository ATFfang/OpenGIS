"""Report generation tools — map snapshots, academic reports, PDF export.
...
@tool(
    ...
    description=(
        ...
        "This tool blocks indefinitely until the user clicks 'Capture' or "
        ...
        "If the agent is cancelled by the user while waiting, the tool "
