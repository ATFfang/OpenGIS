...
Design rules (per implementation plan blazing-vortex-einstein.md):
  ...
  2. The tool is fire-and-forget from the agent's POV: it returns the
  ...
  3. Pin-to-map is a frontend concern.  This tool doesn't know about
...
def _resolve_assets_dir(ctx: ToolContext) -> Path:
