"""Skill: ext_heatmap_render — extension heatmap rendering.
...
from opengis_backend.skills.builtin.ext_registry import register_extension
...
def ext_heatmap_remove(ctx: SkillContext) -> dict[str, str]:
