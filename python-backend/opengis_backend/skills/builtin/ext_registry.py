"""Skill: list_extensions — query available map rendering extensions.
...
parameter schema.  This skill aggregates them into a single list for the
...
def register_extension(ext: dict) -> None:
    ...
    Called by extension modules during skill discovery to announce
